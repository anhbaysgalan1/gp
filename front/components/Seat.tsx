...
export default function Seat({ player, id, reveal }: seatProps) {
    ...
    // Empty seat logic
    if (!player) {
        // Note: Removed the incorrect "Occupied" logic that was showing all empty seats as occupied
        // when the current user was seated elsewhere. Empty seats should only show as occupied
        // if there's actually a player in them (handled by the first condition)
